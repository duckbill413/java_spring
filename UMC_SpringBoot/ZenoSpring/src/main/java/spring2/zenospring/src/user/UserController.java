...
import spring2.zenospring.config.BaseResponse;
import spring2.zenospring.utils.JwtService;

import static spring2.zenospring.config.BaseResponseStatus.POST_USERS_EMPTY_EMAIL;
import static spring2.zenospring.config.BaseResponseStatus.POST_USERS_INVALID_EMAIL;
import static spring2.zenospring.config.BaseResponseStatus.USERS_EMPTY_USER_IDX;
import static spring2.zenospring.utils.ValidationRegex.isRegexEmail;
...
public class UserController {
     ...
     */
    @ResponseBody
    @PatchMapping("") // (PATCH) 127.0.0.1:9000/users?userIdx=?
    public BaseResponse<DeleteUserRes> deleteUserByIdx(@RequestParam(required = true) int userIdx) {
        try {
